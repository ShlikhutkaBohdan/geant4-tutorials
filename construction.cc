...
void MyDetectorConstruction::ConstructCherenkov() {
    ...
    physRadiator = new G4PVPlacement(0, G4ThreeVector(0., 0.0, 0.25 * m), logicRadiator, "physRadiator", logicWorld,
                                     false, 0, true);
...
void MyDetectorConstruction::ConstructScintillator() {
    ...
    for (G4int i = 0; i < 6; i++) {
        for (G4int j = 0; j < 16; j++) {
            ...
            physScintillator = new G4PVPlacement(transformScint, logicScintillator, "physScintillator",
